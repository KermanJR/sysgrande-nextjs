export const createItem = async (itemData) => {
  try {
    const response = await fetch('https://sysgrande-nodejs-1.onrender.com/api/items', {
      method: 'POST',
      headers: {
...
export const updateItem = async (id, itemData) => {
  try {
    const response = await fetch(`https://sysgrande-nodejs-1.onrender.com/api/items/${id}`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
      },
...
export const fetchRegionals = async () => {
  try {
    const response = await fetch('https://sysgrande-nodejs-1.onrender.com/api/regionals', { 
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
...
export const updateItemById = async (itemId, updatedData) => {
  try {
    const response = await fetch(`https://sysgrande-nodejs-1.onrender.com/api/items/${itemId}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
